###########################################################################
## Makefile generated for component 'stereoWidthPlugin'. 
## 
## Makefile     : stereoWidthPlugin_rtw.mk
## Generated on : Sun Dec 04 23:32:28 2022
## Final product: ./stereoWidthPlugin.a
...
PRODUCT_NAME              = stereoWidthPlugin
MAKEFILE                  = stereoWidthPlugin_rtw.mk
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/stereoWidthPlugin -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=stereoWidthPlugin
...
SRCS = $(START_DIR)/codegen/lib/stereoWidthPlugin/stereoWidthPlugin.cpp
...
%.o : $(START_DIR)/codegen/lib/stereoWidthPlugin/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/stereoWidthPlugin/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
stereoWidthPlugin.o : $(START_DIR)/codegen/lib/stereoWidthPlugin/stereoWidthPlugin.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
