...
//
// _coder_stereoWidthPlugin_mex.h
//
// Code generation for function 'onParamChangeCImpl'
//

#ifndef _CODER_STEREOWIDTHPLUGIN_MEX_H
#define _CODER_STEREOWIDTHPLUGIN_MEX_H
...
#endif
// End of code generation (_coder_stereoWidthPlugin_mex.h)
