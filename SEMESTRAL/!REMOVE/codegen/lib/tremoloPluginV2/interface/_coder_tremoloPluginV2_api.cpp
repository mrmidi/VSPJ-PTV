...
//
// _coder_tremoloPluginV2_api.cpp
//
// Code generation for function 'onParamChangeCImpl'
//

// Include files
#include "_coder_tremoloPluginV2_api.h"
#include "_coder_tremoloPluginV2_mex.h"
                             ...
                             real_T **y_data, int32_T *y_size)
{
  real_T *r;
  int32_T i;
  b_emlrt_marshallIn(sp, emlrtAlias(u), parentId, &r, &i);
  *y_size = i;
  *y_data = r;
  emlrtDestroyArray(&u);
}
...
void tremoloPluginV2_atexit()
{
  ...
  tremoloPluginV2_xil_terminate();
  tremoloPluginV2_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void tremoloPluginV2_initialize()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
...
void tremoloPluginV2_terminate()
{
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (_coder_tremoloPluginV2_api.cpp)
