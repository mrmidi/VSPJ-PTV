###########################################################################
## Makefile generated for component 'tremoloPluginV2'. 
## 
## Makefile     : tremoloPluginV2_rtw.mk
## Generated on : Sun Jan 01 23:26:42 2023
## Final product: ./tremoloPluginV2.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/tremoloPluginV2 -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=tremoloPluginV2
...
SRCS = $(START_DIR)/codegen/lib/tremoloPluginV2/tremoloPluginV2.cpp
...
%.o : $(START_DIR)/codegen/lib/tremoloPluginV2/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/tremoloPluginV2/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
tremoloPluginV2.o : $(START_DIR)/codegen/lib/tremoloPluginV2/tremoloPluginV2.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
