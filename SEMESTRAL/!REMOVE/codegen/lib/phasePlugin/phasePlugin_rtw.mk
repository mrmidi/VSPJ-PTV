###########################################################################
## Makefile generated for component 'phasePlugin'. 
## 
## Makefile     : phasePlugin_rtw.mk
## Generated on : Tue Dec 06 23:01:16 2022
## Final product: ./phasePlugin.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/phasePlugin -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=phasePlugin
...
SRCS = $(START_DIR)/codegen/lib/phasePlugin/phasePlugin.cpp
...
%.o : $(START_DIR)/codegen/lib/phasePlugin/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/phasePlugin/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
phasePlugin.o : $(START_DIR)/codegen/lib/phasePlugin/phasePlugin.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
