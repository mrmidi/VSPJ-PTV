...
//
// _coder_phasePlugin_api.cpp
//
// Code generation for function 'onParamChangeCImpl'
//

// Include files
#include "_coder_phasePlugin_api.h"
#include "_coder_phasePlugin_mex.h"
...
void phasePlugin_atexit()
{
  ...
  phasePlugin_xil_terminate();
  phasePlugin_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void phasePlugin_initialize()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
...
// End of code generation (_coder_phasePlugin_api.cpp)
