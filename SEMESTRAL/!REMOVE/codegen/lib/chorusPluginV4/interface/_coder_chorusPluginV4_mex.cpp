                 ...
                 const mxArray *prhs[])
{
  ...
  mexAtExit(&chorusPluginV4_atexit);
  // Module initialization.
  chorusPluginV4_initialize();
...
// End of code generation (_coder_chorusPluginV4_mex.cpp)
