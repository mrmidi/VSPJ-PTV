...
//
// _coder_Chorus_api.cpp
//
// Code generation for function 'onParamChangeCImpl'
//

// Include files
#include "_coder_Chorus_api.h"
#include "_coder_Chorus_mex.h"
...
void Chorus_atexit()
{
  ...
  Chorus_xil_terminate();
  Chorus_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void Chorus_initialize()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
...
// End of code generation (_coder_Chorus_api.cpp)
