###########################################################################
## Makefile generated for component 'Chorus'. 
## 
## Makefile     : Chorus_rtw.mk
## Generated on : Mon Jan 02 01:17:55 2023
## Final product: ./Chorus.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/Chorus -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=Chorus
...
SRCS = $(START_DIR)/codegen/lib/Chorus/rt_nonfinite.cpp $(START_DIR)/codegen/lib/Chorus/rtGetNaN.cpp $(START_DIR)/codegen/lib/Chorus/rtGetInf.cpp $(START_DIR)/codegen/lib/Chorus/Chorus.cpp
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o Chorus.o
...
%.o : $(START_DIR)/codegen/lib/Chorus/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/Chorus/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/Chorus/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/Chorus/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/Chorus/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Chorus.o : $(START_DIR)/codegen/lib/Chorus/Chorus.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
